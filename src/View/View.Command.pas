...
begin
  // Só aplica se existe operação pendente E o usuário digitou algo
  ...
  // MOSTRA o total e NÃO limpa o display aqui.
  AtualizarDisplayComTotal;

  // Apenas “fecha” o ciclo da operação
  FPendente  := opNone;
  FDigitando := False;     // próximo dígito substitui o total na tela
end;
