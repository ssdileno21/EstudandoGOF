...
type
  TfrmBuilder = class(TfrmDefault)
    ...
    mHamburguer: TMemo;
    mFishburguer: TMemo;
    procedure btnMontarHamburguerClick(Sender: TObject);
    procedure btnMontarFishburguerClick(Sender: TObject);
    procedure btnCancelarHamburguerClick(Sender: TObject);
    procedure btnCancelarFishburguerClick(Sender: TObject);
  private
    { Private declarations }
    procedure MontarHamburguer;
    procedure Montarfishburguer;
    procedure LimparPedidoHamburguer;
    procedure LimparPedidoFishburguer;
  public
    { Public declarations }
  end;
...
uses Creational.Builder.Cozinha, Creational.Builder.FishBuilder,
Creational.Builder.HamburguerBuilder, Creational.Builder.Sanduiche,
...
begin
  inherited;
  LimparPedidoFishburguer;
end;

procedure TfrmBuilder.btnCancelarHamburguerClick(Sender: TObject);
begin
  inherited;
  LimparPedidoHamburguer;
end;

procedure TfrmBuilder.btnMontarFishburguerClick(Sender: TObject);
begin
  inherited;
  Montarfishburguer;
end;

procedure TfrmBuilder.btnMontarHamburguerClick(Sender: TObject);
begin
  inherited;
  MontarHamburguer;
end;

procedure TfrmBuilder.LimparPedidoFishburguer;
begin
  mFishburguer.Clear;
end;

procedure TfrmBuilder.LimparPedidoHamburguer;
begin
  mHamburguer.Clear;
end;
